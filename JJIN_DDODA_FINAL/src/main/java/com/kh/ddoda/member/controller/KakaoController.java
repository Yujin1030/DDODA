...
public class KakaoController {
	   ...
	   public static JsonNode getAccessToken(String autorize_code) {
	      ...
	      postParams.add(new BasicNameValuePair("client_id", "ac9a019aaa7361144ef3b2c28761c8b7")); // REST API KEY
	      postParams.add(new BasicNameValuePair("redirect_uri", "http://localhost:8888/KaKaoLogin.doa")); // 리다이렉트
	                                                                                    // URI
