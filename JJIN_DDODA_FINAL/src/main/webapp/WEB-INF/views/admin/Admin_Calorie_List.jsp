...
<body>
	...
	<div class="main">
		<div class="main-name">
			<h2 class="main-name-h2">음식 칼로리</h2>
		</div>
		<div style="width:75%;float:right;text-align:right;padding-right:10px;">
			<button type="button" align="center" class="btn btn-primary" onclick="location.href='cWriteView.doa';">등록하기</button>
		</div>
		...
		<table align="center" width="800" cellspacing="0" style="clear:right;" class="table">
			...
			<c:forEach items="${cList }" var="calorie">
				...
				<tr onclick="location.href='${cDetail}'">
					<td align="center">${calorie.calorieNo }</td>
					<td align="center">${calorie.foodName }</td>
				</tr>
			</c:forEach>
			</c:if>
			<tr align="center">
