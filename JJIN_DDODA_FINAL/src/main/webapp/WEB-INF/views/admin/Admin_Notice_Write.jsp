...
<!-- header -->
	...
	<div class="main-name">
		<h2 class="main-name-h2">공지사항 등록</h2>
	</div>
	<div class="table-wrap">
	<form action="noticeRequireInsert.doa" method="post">
		<table align="center" id="tb" class="table">
			<tr>
				<td>제목</td>
				<td><input type="text" name="sNoticeTitle"></td>
			</tr>
			<tr>
				<td>게시판명</td>
				<td>
					<select class="form-select" aria-label="Default select example" id="sSearchCondition" name="sSearchCondition">
					  ...
					  <option value="opendiary">공유일기</option>
					  <option value="require">요청사항</option>
			...
			<tr>
				<td>내용</td>
				<td><textarea cols="50" rows="7" name="sNoticeContents"></textarea></td>
			</tr>
			<tr>
